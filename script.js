...
function startGame() {
    ...
    bgMusic.play().catch(e => console.log("Audio waiting for interaction context window gesture setup"));
...
function gameLoop() {
    ...
    // LOCKED SCALE: Base speed maps directly to fixed internal dimensions
    ...
    for (let i = obstacles.length - 1; i >= 0; i--) {
        ...
        // TIGHT BOUNDBOX CHECK: Trims dead spaces flawlessly
